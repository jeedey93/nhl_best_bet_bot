...
def update_latest_predictions(preliminary=False):
    ...
    content += ".share-button { background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 12px; padding: 12px 20px; cursor: pointer; font-size: 0.9em; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(16, 185, 129, 0.25); margin-top: 15px; width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; }\n"
    ...
    content += "    var desc = descEl ? descEl.textContent.trim() : '';\n"
    content += "    var firstSentence = desc.split('.')[0] + '.';\n"
    ...
    content += "      </div>\n"
    content += "      <div style=\"padding:22px 28px;background:#0f172a;\">\n"
    content += "        <div style=\"background:linear-gradient(135deg,#064e3b 0%,#065f46 100%);border:1px solid #10b981;border-radius:14px;padding:18px 22px;margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;\">\n"
    content += "          <div>\n"
    content += "            <div style=\"color:#6ee7b7;font-size:0.7em;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:5px;\">AI Pick</div>\n"
    content += "            <div style=\"color:white;font-size:1.25em;font-weight:800;\">${pickLine}</div>\n"
    content += "          </div>\n"
    content += "          ${odds ? `<div style=\"text-align:center;background:rgba(255,255,255,0.08);border-radius:10px;padding:12px 18px;min-width:80px;\"><div style=\"color:#6ee7b7;font-size:0.65em;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:3px;\">Odds</div><div style=\"color:white;font-size:1.5em;font-weight:900;\">${odds}</div></div>` : ''}\n"
    content += "        </div>\n"
    content += "        <div style=\"display:flex;gap:12px;margin-bottom:18px;\">\n"
    content += "          ${confidence ? `<div style=\"flex:1;background:#1e293b;border-radius:12px;padding:14px 16px;border:1px solid #334155;\"><div style=\"color:#94a3b8;font-size:0.65em;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px;\">Confidence</div><div style=\"color:white;font-size:0.9em;font-weight:700;\">${confidence}</div></div>` : ''}\n"
    content += "          ${winProb ? `<div style=\"flex:1;background:#1e293b;border-radius:12px;padding:14px 16px;border:1px solid #334155;\"><div style=\"color:#94a3b8;font-size:0.65em;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px;\">Win Probability</div><div style=\"color:#10b981;font-size:1.6em;font-weight:900;line-height:1;\">${winProb}%</div><div style=\"background:#0f172a;border-radius:4px;height:5px;margin-top:8px;overflow:hidden;\"><div style=\"background:linear-gradient(90deg,#10b981,#34d399);height:100%;width:${winProb}%;border-radius:4px;\"></div></div></div>` : ''}\n"
    content += "        </div>\n"
    content += "        ${firstSentence ? `<div style=\"background:#1e293b;border-radius:12px;padding:16px 18px;margin-bottom:18px;border:1px solid #334155;\"><div style=\"color:#94a3b8;font-size:0.65em;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;\">Analysis</div><div style=\"color:#e2e8f0;font-size:0.82em;line-height:1.6;\">${firstSentence}</div></div>` : ''}\n"
    ...
    content += "    var shareText = '🎯 AI Pick: ' + pickLine + (odds ? ' @ ' + odds : '') + '\\n\\nparieurdiscipline.com';\n"
    ...
    content += "      try {\n"
    content += "        await navigator.share({ text: shareText, files: [file] });\n"
