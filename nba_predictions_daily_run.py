...
def analyze_results(results_text):
    ...
    prompt = (
        ...
        "- EXPLANATION TONE: Keep explanations short, plain-language, and user-friendly (avoid heavy stats jargon).\n"
        "- FORMAT: Provide 2 sentences per play:\n"
        "    - Sentence 1: The numerical edge (Odds/Line variance) and confirm the odds are <= 2.2.\n"
        "    - Sentence 2: A simple, reader-friendly reason (fatigue, matchup, momentum) without technical metrics.\n"
        "\n"
        "### BET OF THE DAY\n"
